...
class StringEncryptorGroovyTest extends GroovyTestCase {
    ...
    public void testJasyptDecryptionShouldAcceptExternallyGeneratedSalt() throws Exception {
        ...
        // These values can be generated by running `$ ./openssl_3_brett_demo.rb` in the terminal
        final String MASTER_KEY = "mybigsecretkey"
        final String CIPHER_TEXT = "0123456789ABCDEFFEDCBA9876543210532ec188a9385763a5ce1240636ec593"
...
//        def jasyptIv = Hex.toHexString(encryptor.encryptor.byteEncryptor.encryptCipher.getIV())
//        logger.info("Jasypt IV: ${jasyptIv}")
...
//        ivBytes = Hex.decode(jasyptIv)
//        logger.info("Hardcoded IV back to Jasypt: ${Hex.toHexString(ivBytes)}")
...
//        if (derivedIv != jasyptIv) {
//            logger.warn("Derived IV does not match Jasypt IV")
//        }

        String recovered = new String(cipher.doFinal(Hex.decode(ct)))
        logger.info("Recovered plaintext: ${recovered}")
